...
interface AnimationTimelineMediaQueryArgs {
  activationWidth: number,
...
export class AnimationTimelineMediaQuery {
  public activationWidth: number
  public properties: AnimateTimelineProperties
  public settings: AnimateTimelineSettings
  // ! This will be implemented
  public disable

  constructor(arg: AnimationTimelineMediaQueryArgs) {
    this.activationWidth = arg.activationWidth
...
export class AnimationTimeline {
  ...
  private mediaQueries: AnimationTimelineMediaQuery[]

  constructor(arg: AnimationTimelineArgs, ...mediaQueries: AnimationTimelineMediaQuery[]) {
  ...
  animateElements(
    animateElements: NodeListOf<HTMLElement>,
    animatedProperties: AnimateTimelineProperties,
    animateSettings: AnimateTimelineSettings
  ) {
