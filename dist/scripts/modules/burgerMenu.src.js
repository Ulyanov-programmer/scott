...
const _BurgerMenu = class {
  constructor(args) {
    ...
    _BurgerMenu.burgerMenuStyles = getComputedStyle(_BurgerMenu.menu);
    _BurgerMenu.burgerMenuTransitionDurationMs = parseFloat(_BurgerMenu.burgerMenuStyles.transitionDuration) * 1e3;
...
BurgerMenu.burgerMenuTransitionDurationMs = 100;
export {
